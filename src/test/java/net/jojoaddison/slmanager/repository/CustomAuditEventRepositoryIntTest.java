...
import net.jojoaddison.slmanager.config.audit.AuditEventConverter;
import net.jojoaddison.slmanager.domain.PersistentAuditEvent;
...
import static net.jojoaddison.slmanager.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
