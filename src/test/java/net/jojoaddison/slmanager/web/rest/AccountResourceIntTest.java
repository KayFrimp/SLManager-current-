...
import net.jojoaddison.slmanager.config.Constants;
import net.jojoaddison.slmanager.domain.Authority;
import net.jojoaddison.slmanager.domain.User;
import net.jojoaddison.slmanager.repository.AuthorityRepository;
import net.jojoaddison.slmanager.repository.UserRepository;
import net.jojoaddison.slmanager.security.AuthoritiesConstants;
import net.jojoaddison.slmanager.service.MailService;
import net.jojoaddison.slmanager.service.UserService;
import net.jojoaddison.slmanager.service.dto.PasswordChangeDTO;
import net.jojoaddison.slmanager.service.dto.UserDTO;
import net.jojoaddison.slmanager.web.rest.errors.ExceptionTranslator;
import net.jojoaddison.slmanager.web.rest.vm.KeyAndPasswordVM;
import net.jojoaddison.slmanager.web.rest.vm.ManagedUserVM;
