...
import { ILecture, Lecture } from 'app/shared/model/lecture.model';
...
describe('Service Tests', () => {
    describe('Lecture Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new Lecture('ID', 'AAAAAAA', 0);
        });
        ...
        describe('Service methods', async () => {
            ...
            it('should return a list of Lecture', async () => {
                const returnedFromService = Object.assign(
                    {
                        courseName: 'BBBBBB',
                        creditHours: 1
